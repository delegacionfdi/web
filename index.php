...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WBQQDT6"
    ...
    <div id="barra">
        <div class="container">
            ...
            <ul class="ul-menu">
                <li>
                    <div id="buscador">
                        <form action="https://google.com/search" method="get" class="posicion_buscar form-inline"
                              id="formbuscador" target="_blank">
                            ...
                            <button type="submit" class="botonbusca" id="btsearch" title="Buscar en la web"
                                    aria-label="Buscar en la web"><span class="fa fa-search" aria-hidden="true"
                                                                        title="Buscar en la web"></span></button>
                        </form>
                        <button class="botoncerrar" id="cerrar_buscador" aria-label="Cerrar buscador"><span
                                    class="fa fa-times" aria-hidden="true" title="Cerrar buscador"></span></button>
                    </div>
                </li>
                <li>
                    <nav class="navbar" role="navigation" id="menusuperior">
                        <div class="navbar-header">
                            <button type="button" class="navbar-toggle" data-toggle="collapse"
                                    data-target=".navbar-sup-collapse" id="collapse-personal">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li>
                        <!--  <a href="/estudiar" title="Estudiar" aria-label="Estudiar">
                             <span class="fa fa-plus-circle" aria-hidden="true" title="Estudiar"></span>
                         </a> -->
                    </li>
                </ul>
            </li>
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li>
                        <!--  <a href="/investigar" title="Investigar" aria-label="Investigar">
                             <span class="fa fa-plus-circle" aria-hidden="true" title="Investigar"></span>
                             </a> -->
                    </li>
                </ul>
            </li>
        ...
        <div class="container carousel_col">
            <div id="carouselUcm" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <article class="item active">
                        <figure>
                            <img src="img/noticias/3-2019-06-28-orgullo lgbt.jpg"
                                 alt="La bandera multicolor ya ondea en nuestro Edificio de Estudiantes. La UCM, espacio de libertad, de convivencia y de seguridad"/>
                        </figure>
                    ...
                    <article class="item">
                        <figure>
                            <img src="img/noticias/7-2019-26-elineau.jpg"
                    ...
                    <article class="item">
                        <figure>
                            <img src="img/noticias/6-2019-4-optativas.jpg"
                        ...
                        <div class="news1_txt carousel-caption-ucm">
                            <h3><a  target="_blank" href="https://informatica.ucm.es/presentacion-optativas-2019-2020 …"
                                   ...
                                   class="enlace">El próximo lunes 10 de junio de 10:30 a 14:00 en @informaticaucm
                                                  ...
                                                  los profesores que las impartirán, las optativas que te puedan
                                                  interesar para el próximo curso!</a></h3>
                        </div>
                    </article>
                    <article class="item">
                        <figure>
                            <img src="img/noticias/5-2019-21-ucmxclima.jpg"
                ...
                <a class="right carousel-control" href="#carouselUcm" role="button" data-slide="next"
                   aria-label="right">
            ...
            <div class="container news2">
                <div class="news2_item">
                    <article>
                        <figure>
                            <img src="img/noticias/3-2019-06-27-matriculacion4.jpg"
                ...
                <div class="news2_item">
                    <article>
                        <figure>
                            <img src="img/destacados/HorarioVerano2019.png" alt="Horario de verano 2019"
    ...
    <div class="container">
        <div class="row" id="restonoticias">
            ...
            <section class="col-sm-6 col-xs-12" id="avisos">
                ...
                <ul class="ulavisos">
                    <li>Representar y defender a los estudiantes de la Facultad de Informática de la Universidad
                        Complutense de Madrid (en adelante U.C.M.) en el ámbito universitario.
                    </li>
                    <li>Atender, informar y asesorar correctamente a los estudiantes de la Facultad de Informática de la
                        U.C.M., así como cualquier estudiante que lo requiera.
                    </li>
                    <li>Fomentar la relación y colaboración tanto entre los estudiantes de la Facultad de Informática de
                        la U.C.M. como con cualquier entidad o institución que pueda enriquecer a dichos estudiantes.
                    </li>
                    <li>Fomentar y organizar actividades que vayan encaminadas al beneficio de los estudiantes de la
                        Facultad de Informática de la U.C.M.
                    </li>
                    <li>Promocionar el asociacionismo universitario dentro de la Facultad de Informática de la U.C.M.
                    </li>
                    <li>Colaborar con los órganos de gobierno de la Facultad de Informática de la U.C.M. para conseguir
                        un mejor funcionamiento de la Universidad.
                    </li>
                </ul>
            </section>
        </div>
...
<nav class="container text-center">
    <ul class="redes">
        <li>
            <a id="link_yb" href="https://www.youtube.com/informaticaucm" class="redsocial" target="_blank">
                <img alt="youtube" src="img/rrss/youtube.png"/>
            </a>
        </li>
        <!-- <li>
            <a id="link_fb" href="https://www.facebook.com/UniComplutense" class="redsocial" target="_blank">
                <img alt="facebook" src="img/rrss/facebook.png" />
            </a>
        </li> -->
        <li>
            <a id="link_tw" href="https://twitter.com/delegacionfdi" class="redsocial" target="_blank">
                <img alt="twitter" src="img/rrss/twitter.png"/>
            </a>
        </li>
        <li>
            <a id="link_tg" href="http://t.me/delegacionfdi" class="redsocial" target="_blank">
                <img alt="telegram" src="img/rrss/telegram.png"/>
            </a>
        </li>
        <!-- <li>
            <a id="link_in" href="https://www.instagram.com/uni.complutense/" class="redsocial" target="_blank">
                <img alt="instagram" src="img/rrss/instagram.png" />
            </a>
        </li-->
    </ul>
</nav>
...
<footer id="pie">
    ...
    <div class="container">
        <div class="row" id="pie_contacto">
            <div class="col-sm-3 col-xs-12">&copy; <a href="https://garciabaameiro.com" target="_blank"> Daniel García
                                                                                                         Baameiro </a>
                                            based on website <a href="https://ucm.es" target="_blank"> Universidad
                                                                                                       Complutense
                                                                                                       Madrid</a></div>
            <div class="col-sm-3 col-xs-12">
                <a target="_blank" href="https://informatica.ucm.es/contacto" title="Contacto">
                    Localización y contacto
                </a>
            </div>
            <div class="col-sm-2 col-xs-12">
                <a target="_blank" href="https://www.ucm.es/aviso-legal" title="Aviso Legal">
                    Aviso Legal
                </a>
            </div>
            <div class="col-sm-3 col-xs-12">
                <a target="_blank" href="https://www.ucm.es/datos-personales" title="Protección de datos">
                    Protección de datos
                </a>
            </div>
            <div class="col-sm-1 col-xs-12">
                <a target="_blank" href="https://ucm.es" title="Universidad Complutense de Madrid">
                    UCM
                </a>
            </div>
        </div>
