...
!function (a, b, c, d) {
    ...
    e.prototype.onResize = function () {
        return !!this._items.length && (
            this._width !== this.$element.width() && (!!this.$element.is(":visible") && (
                this.enter("resizing"),
    ...
    e.prototype.registerEventHandlers = function () {
        ...
        this.settings.responsive !== !1 && this.on(
            b,
            "resize",
        ...
        return this.settings.freeDrag || a.each(g, a.proxy(function (a, h) {
            return "left" === c && b > h - e && b < h + e
                ...
                : "right" === c && b > h - f - e && b < h - f + e
                    ? d = a + 1
                    : this.op(b, "<", h) && this.op(b, ">", g[a + 1] || h - f) && (
                        d = "left" === c
                            ? a + 1
                            : a
                    ),
    ...
    e.prototype.maximum = function (a) {
        ...
        if (e.loop) 
            ...
            for (
                ...
                b = (c += this._items[b].width() + this.settings.margin, !(c > d)) + 1;
            ) 
            ;
            f = b + 1
        } else 
        ...
        if (b.type === e.Type.Event) {
            if (
                ...
                a
                    ...
                    .special[b.name]
                    ._default = function (a) {
                        return !c || !c.apply || a.namespace && a
                            .namespace
                            .indexOf("owl") !== -1
                                ? a.namespace && a
                                    .namespace
...
function (a, b, c, d) {
    ...
    e.prototype.play = function (b) {
        ...
        this._playing || (
            ...
            "youtube" === f.type
                ? c = '<iframe width="' + g + '" height="' + h +
                        '" src="//www.youtube.com/embed/' + f.id + "?autoplay=1&rel=0&v=" + f.id + '" f' +
                        'rameborder="0" allowfullscreen></iframe>'
                : "vimeo" === f.type
                    ? c = '<iframe src="//player.vimeo.com/video/' + f.id + '?autoplay=1" width="' + g +
                            '" height="' + h + '" frameborder="0" webkitallowfullscreen mozallowfullscreen ' +
                            'allowfullscreen></iframe>'
                    : "vzaar" === f.type && (
                        c = '<iframe frameborder="0"height="' + h + '"width="' + g + '" allowfullscreen' +
                        ' mozallowfullscreen webkitAllowFullScreen src="//view.vzaar.com/' + f.id + '/p' +
                        'layer?autoplay=true"></iframe>'
                    ),
...
function (a, b, c, d) {
    ...
    e.prototype.play = function (a, b) {
        ...
        this
            ._core
            .is("rotating") || (this._core.enter("rotating"), this._setAutoPlayInterval())
    },
    e.prototype._getNextTimeout = function (d, e) {
        ...
        b.setTimeout(a.proxy(function () {
            this._paused || this
                ...
                ._core
                .next(e || this._core.settings.autoplaySpeed)
...
function (a, b, c, d) {
    ...
    e.prototype.initialize = function () {
        ...
        this
            ._controls
            .$absolute
            .on("click", "div", a.proxy(function (b) {
                var d = a(b.target)
                    .parent()
