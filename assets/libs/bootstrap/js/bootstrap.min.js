/* ! Bootstrap v4.0.0-beta (https://getbootstrap.com) Copyright 2011-2017 The
                        ...
                        for (var r in o) 
                            if (o.hasOwnProperty(r)) {
                                ...
                                if (!new RegExp(s).test(l)) 
                                    throw new Error(
                                        t.toUpperCase() + ': Option "' + r + '" provided type "' + l + '" but expected ' +
                                        'type "' + s + '".'
                                    )
                            }
                        }
                ...
                var e = "button",
                    ...
                    l = function () {
                        ...
                        return e.prototype.toggle = function () {
                            ...
                            n && this
                                ._element
                                .setAttribute("aria-pressed", !t(this._element).hasClass(r.ACTIVE)),
                ...
                var e = "carousel",
                    ...
                    _ = function () {
                        ...
                        l.prototype.pause = function (e) {
                            e || (this._isPaused = !0),
                            t(this._element).find(p.NEXT_PREV)[0] && r.supportsTransitionEnd() && (
                        ...
                        l.prototype._addEventListeners = function () {
                            ...
                            "hover" === this._config.pause && (
                                t(this._element).on(d.MOUSEENTER, function (t) {
                                    return e.pause(t)
                ...
                var e = "collapse",
                    ...
                    p = function () {
                        function a(e, i) {
                            ...
                            this._element = e,
                            this._config = this._getConfig(i),
                            this._triggerArray = t.makeArray(t(
                        ...
                        a.prototype.show = function () {
                            ...
                            if (!this._isTransitioning && !t(this._element).hasClass(u.SHOW)) {
                                var n = void 0,
                                    i = void 0;
                                if (
                                    this._parent && ((n = t.makeArray(t(this._parent).children().children(f.ACTIVES))).length || (n = null)),
                                    ...
                                    if (t(this._element).trigger(o), !o.isDefaultPrevented()) {
                                        ...
                                        this
                                            ._element
                                            .style[l] = 0,
                                        this._triggerArray.length && t(this._triggerArray)
                            ...
                            if (!this._isTransitioning && t(this._element).hasClass(u.SHOW)) {
                                ...
                                if (t(this._element).trigger(n), !n.isDefaultPrevented()) {
                                    ...
                                    if (
                                        ...
                                        t(this._element).addClass(u.COLLAPSING).removeClass(u.COLLAPSE).removeClass(
                                            u.SHOW
                                        ),
                                        ...
                                        for (var o = 0; o < this._triggerArray.length; o++) {
                                            ...
                                            null !== a && (
                                                t(a).hasClass(u.SHOW) || t(s).addClass(u.COLLAPSED).attr("aria-expanded", !1)
                                            )
                                        }
                                    this.setTransitioning(!0);
                                    var l = function () {
                ...
                var e = "dropdown",
                    ...
                    g = function () {
                                ...
                                if (l._clearMenus(), !n) {
                                    ...
                                    if (t(e).trigger(o), !o.isDefaultPrevented()) {
                                        ...
                                        t(e).hasClass(u.DROPUP) && (
                                            t(this._menu).hasClass(u.MENULEFT) || t(this._menu).hasClass(u.MENURIGHT)
                                        ) && (r = e),
                                        this._popper = new Popper(r, this._menu, this._getPopperConfig()),
                                        "ontouchstart" in document.documentElement && !t(e)
                                            .closest(d.NAVBAR_NAV)
                                            .length && t("body")
                                            .children()
                        ...
                        l.prototype._getConfig = function (n) {
                            ...
                            return void 0 !== i.placement && (i.placement = f[
                                i
                                    .placement
                                    .toUpperCase()
                            ]),
                        ...
                        l.prototype._getPlacement = function () {
                            ...
                            return e.hasClass(u.DROPUP) || this._config.placement === f.TOP
                        ...
                        l._dataApiKeydownHandler = function (e) {
                            if (!(!h.test(e.which) || /button/i.test(e.target.tagName) && 32 === e.which || /input|textarea/i.test(e.target.tagName) || (
                                e.preventDefault(),
                                e.stopPropagation(),
                        ...
                        a.prototype._enforceFocus = function () {
                            ...
                            t(document)
                                ...
                                .on(c.FOCUSIN, function (n) {
                                    document === n.target || e._element === n.target || t(e._element)
                                        .has(n.target)
                                        .length || e
                                        ._element
                                        .focus()
                        ...
                        a._jQueryInterface = function (e, n) {
                            return this.each(function () {
                                var o = t(this).data("bs.modal"),
                                    r = t.extend({}, a.Default, t(this).data(), "object" === (
                                        void 0 === e
                                            ? "undefined"
                                            : i(e)
                                    ) && e);
                    ...
                    f = function () {
                        function s(e, i) {
                            ...
                            this._selector = this._config.target + " " + u.NAV_LINKS + "," + this._config.target +
                                    " " + u.LIST_ITEMS + "," + this._config.target + " " + u.DROPDOWN_ITEMS,
                            this._offsets = [],
                            this._targets = [],
                        ...
                        s.prototype._activate = function (e) {
                            ...
                            i.hasClass(c.DROPDOWN_ITEM)
                                ? (
                                    i.closest(u.DROPDOWN).find(u.DROPDOWN_TOGGLE).addClass(c.ACTIVE),
                                    i.addClass(c.ACTIVE)
                                )
                                : (
                                    i.addClass(c.ACTIVE),
                        ...
                        return e.prototype.show = function () {
                            ...
                            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(s.ACTIVE) || t(this._element).hasClass(s.DISABLED))) {
                                ...
                                if (
                                    ...
                                    n
                                        ? this._activate(n, n.parentNode, d)
                                        : d()
                                }
                            }
                        },
                    ...
                    m = function () {
                        ...
                        a.prototype.show = function () {
                            ...
                            if (this.isWithContent() && this._isEnabled) {
                                ...
                                this
                                    .element
                                    .setAttribute("aria-describedby", s),
                                this.setContent(),
                                ...
                                t.contains(this.element.ownerDocument.documentElement, this.tip) || t(o).appendTo(
                                    c
                                ),
                        ...
                        a.prototype.hide = function (e) {
                            var n = this,
                                ...
                                s = function () {
                                    n._hoverState !== d.SHOW && i.parentNode && i
                                        .parentNode
                                        .removeChild(i),
                                    n._cleanTipClass(),
                                    n
